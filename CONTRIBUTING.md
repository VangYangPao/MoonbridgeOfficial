Contributing to Moonbridge Core
============================

The Moonbridge Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Moonbridge Core project, and is not to be
confused with overall Moonbridge Network Protocol consensus changes.

Whether a pull request is merged into Moonbridge Core rests with the project merge
...
Patches that change Moonbridge consensus rules are considerably more involved than
...
Where a patch set proposes to change the Moonbridge consensus, it must have been
...
The project leader is the release manager for each Moonbridge Core release.
