...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/moonbridge-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/moonbridge-cli.cpp \
           src/moonbridge-tx.cpp \
           src/moonbridge.cpp \
           src/db.cpp \
           ...
           src/qt/moonbridge.cpp \
           src/qt/moonbridgestrings.cpp \
...
RESOURCES += src/qt/moonbridge.qrc src/qt/moonbridge_locale.qrc

TRANSLATIONS += src/qt/locale/moonbridge_bg.ts \
                src/qt/locale/moonbridge_de.ts \
                src/qt/locale/moonbridge_en.ts \
                src/qt/locale/moonbridge_es.ts \
                src/qt/locale/moonbridge_fi.ts \
                src/qt/locale/moonbridge_fr.ts \
                src/qt/locale/moonbridge_it.ts \
                src/qt/locale/moonbridge_ja.ts \
                src/qt/locale/moonbridge_pl.ts \
                src/qt/locale/moonbridge_pt.ts \
                src/qt/locale/moonbridge_ru.ts \
                src/qt/locale/moonbridge_sk.ts \
                src/qt/locale/moonbridge_sv.ts \
                src/qt/locale/moonbridge_vi.ts \
                src/qt/locale/moonbridge_zh_CN.ts \
                src/qt/locale/moonbridge_zh_TW.ts
