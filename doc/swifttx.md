...
This mechanism has been integrated into Bitcore-Node-Moonbridge which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Moonbridge-Project/insight-api-moonbridge#web-socket-api](https://github.com/Moonbridge-Project/insight-api-moonbridge#web-socket-api) 
* API: [https://github.com/Moonbridge-Project/insight-api-moonbridge#swifttx-transactions](https://github.com/Moonbridge-Project/insight-api-moonbridge#swifttx-transactions) 
...
By default, the Moonbridge Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Moonbridge Core daemon:
