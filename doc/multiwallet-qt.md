...
In order to support loading of multiple wallets in moonbridge-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is moonbridge.cpp.
...
Changes to moonbridge.cpp
----------------------
moonbridge.cpp is the entry point into moonbridge-qt, and as such, will require some minor modifications to provide hooks for
