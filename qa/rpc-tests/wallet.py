...
#   c) node1 mines 32 blocks, so now node 0 has 60001mbr, node 1 has 4250mbr, node2 has none.
#   d) node0 sends 601 mbr to node2, in two transactions (301 mbr, then 300 mbr).
