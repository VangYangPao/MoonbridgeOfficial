...
!define COMPANY "Moonbridge Core project"
...
!else
InstallDir $PROGRAMFILES\Moonbridge
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Moonbridge Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\moonbridge-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Moonbridge Core (testnet, -bit).lnk" "$INSTDIR\moonbridge-qt" "-testnet" "$INSTDIR\moonbridge-qt" 1
    ...
    WriteRegStr HKCR "moonbridge" "URL Protocol" ""
    WriteRegStr HKCR "moonbridge" "" "URL:Moonbridge"
    WriteRegStr HKCR "moonbridge\DefaultIcon" "" $INSTDIR\moonbridge-qt
    WriteRegStr HKCR "moonbridge\shell\open\command" "" '"$INSTDIR\moonbridge-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\moonbridge-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Moonbridge Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Moonbridge.lnk"
