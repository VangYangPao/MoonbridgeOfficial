...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Moonbridge server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Moonbridge server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Moonbridge features */
        {"moonbridge", "masternode", &masternode, true, true, false},
        {"moonbridge", "listmasternodes", &listmasternodes, true, true, false},
        {"moonbridge", "getmasternodecount", &getmasternodecount, true, true, false},
        {"moonbridge", "masternodeconnect", &masternodeconnect, true, true, false},
        {"moonbridge", "masternodecurrent", &masternodecurrent, true, true, false},
        {"moonbridge", "masternodedebug", &masternodedebug, true, true, false},
        {"moonbridge", "startmasternode", &startmasternode, true, true, false},
        {"moonbridge", "createmasternodekey", &createmasternodekey, true, true, false},
        {"moonbridge", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"moonbridge", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"moonbridge", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"moonbridge", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"moonbridge", "getmasternodescores", &getmasternodescores, true, true, false},
        {"moonbridge", "mnbudget", &mnbudget, true, true, false},
        {"moonbridge", "preparebudget", &preparebudget, true, true, false},
        {"moonbridge", "submitbudget", &submitbudget, true, true, false},
        {"moonbridge", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"moonbridge", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"moonbridge", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"moonbridge", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"moonbridge", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"moonbridge", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"moonbridge", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"moonbridge", "checkbudgets", &checkbudgets, true, true, false},
        {"moonbridge", "mnsync", &mnsync, true, true, false},
        {"moonbridge", "spork", &spork, true, true, false},
        {"moonbridge", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"moonbridge", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> moonbridge-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37512/\n";
}
