...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000002414b0c6ed5e19f048338ddc7eeac4e725da67f27c4980383d8ed57d1c3"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1532217600, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 37511;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Moonbridge starting difficulty is 1 / 2^12
        ...
        const char* pszTimestamp = "Moonbridge!!! 7/22/2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1532217600;//2018.7.22
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 60 * 60; // Moonbridge: 1 hr
        nTargetSpacing = 120;  // Moonbridge: 2 min
        nLastPOWBlock = 500;
        nMaturity = 30;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("moonbridge.tech", "testnet-seeds.moonbridge.tech"));             // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("gig8.com", "testnet-seeds.moonbridge.gig8.com"));      // Secondary DNS Seeder

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 88); // Testnet moonbridge addresses start with 'b''
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 125);  // Testnet moonbridge script addresses start with 's'
        ...
        // Testnet moonbridge BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 60 * 60; // Moonbridge: 1 hour
        nTargetSpacing = 120;        // Moonbridge: 2 min
