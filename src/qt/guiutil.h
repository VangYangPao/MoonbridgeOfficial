...
/** Utility functions used by the Moonbridge Qt UI.
 */
namespace GUIUtil
{
...
// Render Moonbridge addresses in monospace font
...
// Parse "moonbridge:" URI into recipient object, return true on successful parsing
