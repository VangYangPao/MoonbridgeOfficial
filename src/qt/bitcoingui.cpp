                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Moonbridge Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Moonbridge address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and moonbridge: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMBR"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Moonbridge Core"), this);
    aboutAction->setStatusTip(tr("Show information about Moonbridge Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Moonbridge"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Moonbridge addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Moonbridge addresses"));
    ...
    openAction->setStatusTip(tr("Open a Moonbridge: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Moonbridge Core help message to get a list with possible Moonbridge command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Moonbridge Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Moonbridge network", "", count));
}
...
{
    QString strTitle = tr("Moonbridge Core"); // default title
