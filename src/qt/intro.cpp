...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Moonbridge Core"),
     ...
     * override -datadir in the moonbridge.conf file in the default data directory
     * (to be consistent with moonbridged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
