...
/* Moonbridge GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Moonbridge"
#define QAPP_ORG_DOMAIN "moonbridge.tech"
#define QAPP_APP_NAME_DEFAULT "Moonbridge-Qt"
#define QAPP_APP_NAME_TESTNET "Moonbridge-Qt-testnet"
