...
public:
    ...
    void setupUi(QDialog *MultisigDialog)
    {
        ...
        multisigTabWidget->setStyleSheet(QStringLiteral("QScrollArea{border: 1px solid #1f1f1f;}"));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/import"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/icons/commit"), QSize(), QIcon::Normal, QIcon::Off);
...
#ifndef QT_NO_TOOLTIP
        addDestinationButton->setToolTip(QApplication::translate("MultisigDialog", "Add destinations to send MBR to", 0));
#endif // QT_NO_TOOLTIP
