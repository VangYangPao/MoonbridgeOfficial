 ...
 */
    ...
    typeWidget->addItem(tr("Received Mbr from zMbr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMbr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMbr));
