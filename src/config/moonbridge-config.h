/* src/config/moonbridge-config.h.  Generated from moonbridge-config.h.in by configure.  */
/* src/config/moonbridge-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "moonbridge.tech"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Moonbridge Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Moonbridge Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "moonbridge"
