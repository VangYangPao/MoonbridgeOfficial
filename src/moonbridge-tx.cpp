...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Moonbridge Core moonbridge-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  moonbridge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded moonbridge transaction") + "\n" +
                               "  moonbridge-tx [options] -create [commands]   " + _("Create hex-encoded moonbridge transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded moonbridge transaction
